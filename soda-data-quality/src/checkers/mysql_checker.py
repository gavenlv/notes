"""
MySQL data quality checker following Strategy pattern
"""
...
class MySQLDataQualityChecker(BaseDataQualityChecker):
    """MySQL-specific data quality checker"""
    ...
    def run_all_checks(self) -> Dict[str, Any]:
        """Run all MySQL data quality checks"""
        self._logger.info("Starting MySQL data quality checks")
